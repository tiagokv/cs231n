...
class TwoLayerNet(object):
    ...
    def loss(self, X, y=None):
        ...
        error_sign, dW2, db2 = affine_backward(error_sign, cache2)
        _, dW1, db1 = affine_relu_backward(error_sign, cache1)
...
class FullyConnectedNet(object):
    ...
    def loss(self, X, y=None):
        ...
        error_sign, dWlast, dblast = affine_backward(error_sign, cache_last)
        grads['W{}'.format(self.num_layers)] = dWlast + self.reg * self.params['W{}'.format(self.num_layers)]
